...
// Source: github.com/techschool/samplebank/db/sqlc (interfaces: Store)
...
// CreateTransferes mocks base method.
func (m *MockStore) CreateTransferes(arg0 context.Context, arg1 db.CreateTransferesParams) (db.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateTransferes", arg0, arg1)
	ret0, _ := ret[0].(db.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CreateTransferes indicates an expected call of CreateTransferes.
func (mr *MockStoreMockRecorder) CreateTransferes(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateTransferes", reflect.TypeOf((*MockStore)(nil).CreateTransferes), arg0, arg1)
}
...
// GetAccountForUpdat mocks base method.
func (m *MockStore) GetAccountForUpdat(arg0 context.Context, arg1 int64) (db.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAccountForUpdat", arg0, arg1)
	ret0, _ := ret[0].(db.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetAccountForUpdat indicates an expected call of GetAccountForUpdat.
func (mr *MockStoreMockRecorder) GetAccountForUpdat(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAccountForUpdat", reflect.TypeOf((*MockStore)(nil).GetAccountForUpdat), arg0, arg1)
}
...
// ListTransferes mocks base method.
func (m *MockStore) ListTransferes(arg0 context.Context, arg1 db.ListTransferesParams) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListTransferes", arg0, arg1)
	ret0, _ := ret[0].([]db.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListTransferes indicates an expected call of ListTransferes.
func (mr *MockStoreMockRecorder) ListTransferes(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListTransferes", reflect.TypeOf((*MockStore)(nil).ListTransferes), arg0, arg1)
}
...
// UpateEntry mocks base method.
func (m *MockStore) UpateEntry(arg0 context.Context, arg1 db.UpateEntryParams) (db.Entry, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpateEntry", arg0, arg1)
	ret0, _ := ret[0].(db.Entry)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// UpateEntry indicates an expected call of UpateEntry.
func (mr *MockStoreMockRecorder) UpateEntry(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpateEntry", reflect.TypeOf((*MockStore)(nil).UpateEntry), arg0, arg1)
}
